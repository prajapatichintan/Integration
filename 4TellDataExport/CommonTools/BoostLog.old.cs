...
namespace _4_Tell.Utilities
{
	...
	public class Accumulator
	{
		...
		public int TTM = 0; //TTM = Trailing Twelve Months
		...
		public void Add()
		{
			...
			ThisYear++;
			TTM++;
			RollingMonths[m_logMonth] += 1;
			RollingHours[m_logHour] += 1;
		}
	...
	class BoostLog : IDisposable
	{
		...
		private static string m_dataPath = FileIO.DataPathRoot;
      ...
      if(!this.disposed)
      {
		...
		//return true if an existing client and false if it had to be added
		public bool AddCall(string alias)
		{
			ClientLog client;
			bool found = GetClient(alias, out client);
			client.Calls.Add();	
